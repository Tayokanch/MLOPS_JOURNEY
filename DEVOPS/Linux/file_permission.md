...
## HOW TO CHECK THE OWNER/USER OF A FILE AND THE PERMSION
 - `ls -l filename`: Check the user of the file and what permission they have
...
## MODIFYING FILE PERMISSION WITH NUMERIC

  - `chmod 777 file_name` : full access to the Owner, group, and others.

  - `chmod 500 file_name`: Provide Read and execute access to Owners, groups and others
